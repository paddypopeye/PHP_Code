...
?>
	...
	<div class="content_wrapper">
		...
		<div id="content_area">
			...
			<!--products box starts-->	
			<div id="products_box">
				<h2 style="color: red;"><br><br> Welcome Back: <br><h2 style="color: black;"><?php echo $_SESSION['customer_email']?><br><br></h2></h2>
				<h2 style="color: red;">Your Payment was cancelled</h2><br><h2>payment failed</h2>
				<h3><br><br><a class="blink_text2" href="index.php" style="color: red; text-decoration: none;"> <h2>Return to the Shop</h2> </a></h3>
