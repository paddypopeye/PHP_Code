...
<div id="products_box">
	<form method="post" action="" enctype="multipart/form-data">
			<table align="center" width="750">
				...
				<td colspan="6"><h2>Edit your Account</h2>
				</td>
			</tr>
			...
			<tr>
				...
				<td align="left"><input value="<?php echo $user_img; ?>" selected="selected" type="file" name="cust_img" required/><img src="customer_images/<?php echo $user_img;?>" width="50" height="50" /></td>
			</tr>			
			<tr>
		...
		<tr align="center">
			<td colspan="6" align="center"><input type="submit" name="update_acc" value="Update Account"/></td>
		</tr>
	</table>
</form>
</div>
...
if (isset($_POST['update_acc'])) {
		...
		move_uploaded_file($cust_img_tmp,"customer_images/$cust_img");
